...
class SettingsViewModelTest {
  ...
  fun loadProfile_LoadsExistingProfileIntoUiState() = runTest {
    val profile = Profile(uid = "u1", name = "Alice", username = "alice_ok", school = "Harvard", schoolYear = "3")
  ...
  fun editUsername_WithInvalidFormat_SetsErrorMessage() = runTest {
    ...
    val state = viewModel.uiState.value
    assertEquals("Invalid username format (3–20 chars, lowercase, ., -, _ allowed)", state.invalidUsernameMsg)
