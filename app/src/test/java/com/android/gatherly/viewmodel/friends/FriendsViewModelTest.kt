...
class FriendsViewModelTest {
  ...
  fun fill_repositories() {
    ...
    fun testRefreshFriends_CatchesExceptionAndSetsErrorMsg() = runTest {
        ...
        val throwingRepository = object : ProfileRepository {

            // Surcharge la méthode à tester pour lancer une exception
            override suspend fun getFriendsAndNonFriendsUsernames(currentUserId: String): com.android.gatherly.model.friends.Friends {
            ...
            override suspend fun updateUsername(uid: String, oldUsername: String?, newUsername: String): Boolean = false
            ...
            override suspend fun searchProfilesByUsernamePrefix(prefix: String, limit: Int): List<Profile> = emptyList()
            override suspend fun initProfileIfMissing(uid: String, defaultPhotoUrl: String): Boolean = false
