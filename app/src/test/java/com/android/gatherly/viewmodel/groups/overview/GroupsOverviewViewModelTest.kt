...
class GroupsOverviewViewModelTest {
  ...
  @Test
  fun onSignedOut_SetsSignedOutFlagAndCallsAuthAndCredentialManager() = runTest {
    // Arrange: Create a mock auth
    ...
    // Act: Call onSignedOut
    viewModel.onSignedOut(mockCredentialManager)
    advanceUntilIdle()
