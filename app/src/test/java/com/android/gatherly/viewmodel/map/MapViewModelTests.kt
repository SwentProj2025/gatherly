...
class MapViewModelTests {
  ...
  @Ignore(
      "EventsLocalRepository recomputes status from date via updateEventStatus(); " +
          "fixtures dated Christmas 2025 return as PAST and get filtered out. " +
          "Broken on main since Dec 26, 2025.")
  @OptIn(ExperimentalCoroutinesApi::class)
  @Test
