...
object MapViewModelTestsEvents {
    ...
    val upcomingEventWithLocation1 =
        Event(
            ...
            endTime = endTime,
            creatorId = "gersende",
            participants = listOf("gersende", "colombe", "claire", "gab", "alessandro", "clau", "mohamed"),
    ...
    /**
     * Comprehensive list of all test events covering all combinations of status and location. Used to verify that the map filtering logic correctly identifies only the drawable events.
     */
