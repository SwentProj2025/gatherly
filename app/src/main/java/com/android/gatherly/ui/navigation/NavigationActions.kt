...
sealed class Screen(
    ...
    object HomePage : Screen(route = "home_page", name = "Home Page")

    object OverviewToDo : Screen(route = "overview", name = "Overview", isTopLevelDestination = true)
    ...
    object FocusTimerInitScreen : Screen(route = "focus_timer_init_screen", name = "Initiate Focus Timer")
