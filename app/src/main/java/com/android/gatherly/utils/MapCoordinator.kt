...
/**
 * A utility class to coordinate map centering requests based on event or Todos IDs. It allows
 * requesting the map to center on a specific event / todo and tracks whether the request has been
 * consumed.
 */
class MapCoordinator {
  /**
   * Data class representing a centering request for a specific event or todo.
   *
