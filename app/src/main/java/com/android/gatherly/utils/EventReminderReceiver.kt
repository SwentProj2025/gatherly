...
/**
 * Receives the alarm fired by [EventAlarmScheduler] at event start time
 * and creates an in-app EVENT_REMINDER notification for the given user using [EventNotificationScheduler].
 */
class EventReminderReceiver : BroadcastReceiver() {
    companion object{
        ...
        fun setTestProviders(
            provider: (Context) -> NotificationsRepository
        ){
