...
class SettingsScreenTest {
  ...
  /** Initializes the in-memory profile repository before each test. */
  @Before
  fun setUp() {
  ...
  /** Pre-populates the repository with a default profile for the current user. */
  ...
  /**
   * Sets the SettingsScreen content with a mocked signed-in (non-anonymous) user.
   *
   * Initializes the ViewModel and injects it into the composable under test.
   */
  ...
  /**
   * Ensures that all essential SettingsScreen components are present and visible, waiting robustly
   * for the first full frame to settle.
   */
  @Test
  ...
  /** Verifies that invalid usernames display an error message. */
  @Test
  ...
  /** Verifies that empty usernames display an error message. */
  @Test
  ...
  /**
   * Ensures that entering a valid username along with a valid name enables the Save button on the
   * Settings screen.
   */
  @Test
  ...
  /**
   * Verifies that entering a valid username does not show an error message or other invalid state
   * indicator. (Optional confirmation text check)
   */
  @Test
  ...
  /**
   * Scrolls to the last editable field (School Year) to verify that it can be reached even if it’s
   * not initially visible on smaller screens.
   */
  @Test
  ...
  /**
   * Verifies that tapping the profile picture opens the status picker dialog and displays all
