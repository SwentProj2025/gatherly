...
class GroupsRepositoryFirestoreTest : FirestoreGroupsGatherlyTest() {
   ...
   */
  @Test
  fun getUserGroups_returns_only_user_groups() = runTest (timeout = 120.seconds) {
    // Add group as user1
    repository.addGroup(group1)
  ...
  @Test
  fun getGroup_returns_exact_group() = runTest (timeout = 120.seconds) {
    repository.addGroup(group1)
  ...
  @Test
  fun getGroup_throws_when_not_found() = runTest (timeout = 120.seconds) {
    assertFailsWith<NoSuchElementException> { repository.getGroup("non_existing_id") }
  }

  @Test
  fun addGroup_with_initial_members_stores_correctly() = runTest (timeout = 120.seconds) {
   ...
   */
  @Test
  fun addGroup_automatically_adds_creator_as_member_and_admin() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun addGroup_with_null_description_stores_correctly() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun editGroup_updates_existing_group() = runTest (timeout = 120.seconds) {
    repository.addGroup(group1)
  ...
  @Test
  fun editGroup_throws_security_exception_when_not_admin() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun deleteGroup_removes_it() = runTest (timeout = 120.seconds) {
    repository.addGroup(group1)
    repository.addGroup(group2)
  ...
  @Test
  fun deleteGroup_throws_security_exception_when_not_admin() = runTest (timeout = 120.seconds) {
    val testedGroup = group3.copy(memberIds = listOf(user2Id, user3Id), adminIds = listOf(user2Id))
    repository.addGroup(testedGroup)
  ...
  @Test
  fun addMember_adds_user_to_memberIds() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun addMember_multiple_users() = runTest (timeout = 120.seconds) {
   ...
   */
  @Test
  fun addMember_throws_security_exception_when_not_admin() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun removeMember_removes_user_from_memberIds() = runTest (timeout = 120.seconds) {
    val testedGroup = group2.copy(memberIds = listOf(user1Id, user2Id), adminIds = listOf(user1Id))
    repository.addGroup(testedGroup)
   ...
   */
  @Test
  fun removeMember_prevents_removing_last_admin() = runTest (timeout = 120.seconds) {
    val testedGroup = group2.copy(memberIds = listOf(user1Id, user2Id), adminIds = listOf(user1Id))
    repository.addGroup(testedGroup)
   ...
   */
  @Test
  fun removeMember_allows_self_removal() = runTest (timeout = 120.seconds) {
    val testedGroup =
   ...
   */
  @Test
  fun removeMember_throws_security_exception_when_not_admin() = runTest (timeout = 120.seconds) {
    val testedGroup =
        group2.copy(memberIds = listOf(user1Id, user2Id, user3Id), adminIds = listOf(user1Id))
    repository.addGroup(testedGroup)
  ...
  @Test
  fun addAdmin_adds_user_to_adminIds() = runTest (timeout = 120.seconds) {
    val testedGroup = group2.copy(memberIds = listOf(user1Id, user2Id), adminIds = listOf(user1Id))
    repository.addGroup(testedGroup)
   ...
   */
  @Test
  fun addAdmin_requires_candidate_user_to_be_member_first() = runTest (timeout = 120.seconds) {
    val testedGroup = group2.copy(memberIds = listOf(user1Id), adminIds = listOf(user1Id))
    repository.addGroup(testedGroup)
   ...
   */
  @Test
  fun addAdmin_throws_security_exception_when_not_admin() = runTest (timeout = 120.seconds) {
    val testedGroup =
        group2.copy(memberIds = listOf(user1Id, user2Id, user3Id), adminIds = listOf(user1Id))
    repository.addGroup(testedGroup)
  ...
  @Test
  fun removeAdmin_removes_user_from_adminIds() = runTest (timeout = 120.seconds) {
    val testedGroup =
   ...
   */
  @Test
  fun removeAdmin_prevents_removing_last_admin() = runTest (timeout = 120.seconds) {
    val testedGroup = group2.copy(memberIds = listOf(user1Id, user2Id), adminIds = listOf(user1Id))
    repository.addGroup(testedGroup)
   ...
   */
  @Test
  fun removeAdmin_throws_security_exception_when_not_admin() = runTest (timeout = 120.seconds) {
    val testedGroup =
        group2.copy(
