...
class NotificationsRepositoryFirestoreTest : FirestoreNotificationsGatherlyTest() {
  ...
  /**
   * Verifies that [NotificationsRepository.getNewId] generates unique, non-empty identifiers for
   * notifications.
   */
  @Test
  ...
  /**
   * Verifies that a notification added to Firestore can be retrieved by its ID with all fields
   * preserved.
   */
  @Test
  ...
  /**
   * Verifies that [NotificationsRepository.getUserNotifications] only returns notifications
  ...
  /**
   * Verifies that calling [NotificationsRepository.markAsRead] updates the read status of a
   * notification.
   */
  @Test
  ...
  /**
   * Verifies that deleting a notification removes it from Firestore and from the user's
   * notification list.
   */
  @Test
  ...
  /**
   * Verifies that attempting to fetch notifications for another user is not allowed and throws a
   * [SecurityException].
   */
  ...
  /**
   * Verifies that accessing a notification belonging to another user is not allowed and throws a
  ...
  /**
   * Verifies that deleting another user's notification is not allowed and throws a
   * [NoSuchElementException].
   */
  @Test(expected = NoSuchElementException::class)
  ...
  /**
   * Verifies that marking another user's notification as read is not allowed and throws a
   * [NoSuchElementException].
   */
  @Test(expected = NoSuchElementException::class)
  ...
  /**
   * Verifies that requesting a notification with an invalid ID throws a [NoSuchElementException].
   */
  @Test(expected = NoSuchElementException::class)
  ...
  /**
   * Verifies that marking a non-existent notification as read throws a [NoSuchElementException].
   */
  @Test(expected = NoSuchElementException::class)
  ...
  /** Verifies that deleting a non-existent notification throws a [NoSuchElementException]. */
  @Test(expected = NoSuchElementException::class)
  ...
  /**
   * Verifies that retrieving notifications for a user with no notifications returns an empty list.
   */
  @Test
  ...
  /**
   * Verifies that adding a notification with an empty recipient ID is rejected with an
  ...
  /**
   * Verifies that all fields of a notification are preserved when stored and retrieved from
   * Firestore.
   */
  @Test
  ...
  /**
   * Verifies that marking a notification as read only changes the wasRead field and leaves all
  ...
  /**
   * Verifies that notifications returned by [NotificationsRepository.getUserNotifications] are
   * ordered by emission time in descending order.
   */
  @Test
