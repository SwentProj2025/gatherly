...
class NotificationsRepositoryFirestoreTest : FirestoreNotificationsGatherlyTest() {
  ...
  @Test
  fun getNewId_returnsUniqueNonEmptyIds() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun addNotification_andGetNotification_returnsCorrectNotification() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun getUserNotifications_returnsNotificationsForCurrentUserOnly() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun markAsRead_updatesNotificationReadStatus() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun deleteNotification_removesNotification() = runTest (timeout = 120.seconds) {
  ...
  fun getUserNotifications_forDifferentUser_throwsSecurityException() = runTest (timeout = 120.seconds) {
  ...
  fun getNotification_forDifferentUser_throwsNoSuchElementException() = runTest (timeout = 120.seconds) {
    // Add a notification for user2
    signInWithToken(user2Token)
    val newId = repository.getNewId()
  ...
  @Test(expected = NoSuchElementException::class)
  fun deleteNotification_forDifferentUser_throwsException() = runTest (timeout = 120.seconds) {
    // Add a notification for user2
    signInWithToken(user2Token)
    val newId = repository.getNewId()
    val notification = eventReminder2_template.copy(id = newId, recipientId = user2Id)
  ...
  @Test(expected = NoSuchElementException::class)
  fun markAsRead_forDifferentUser_throwsException() = runTest (timeout = 120.seconds) {
    // Add a notification for user2
    signInWithToken(user2Token)
    val newId = repository.getNewId()
    val notification = eventReminder2_template.copy(id = newId, recipientId = user2Id)
  ...
  @Test(expected = NoSuchElementException::class)
  fun getNotification_withInvalidId_throwsException() = runTest (timeout = 120.seconds) {
  ...
  @Test(expected = NoSuchElementException::class)
  fun markAsRead_withInvalidId_throwsException() = runTest (timeout = 120.seconds) {
    // Add some notification for user1
    val newId = repository.getNewId()
    val notification = todoReminder1_template.copy(id = newId, recipientId = user1Id)
    repository.addNotification(notification)
  ...
  @Test(expected = NoSuchElementException::class)
  fun deleteNotification_withInvalidId_throwsException() = runTest (timeout = 120.seconds) {
    // Add some notification for user1
    val newId = repository.getNewId()
    val notification = todoReminder1_template.copy(id = newId, recipientId = user1Id)
    repository.addNotification(notification)
  ...
  @Test
  fun getUserNotifications_withNoNotifications_returnsEmptyList() = runTest (timeout = 120.seconds) {
  ...
  fun addNotification_withEmptyRecipientId_throwsException() = runTest (timeout = 120.seconds) {
    val notification =
        friendRequest1_template.copy(
  ...
  @Test
  fun addNotification_preservesAllFields() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun markAsRead_onlyChangesWasReadField() = runTest (timeout = 120.seconds) {
  ...
  @Test
  fun getUserNotifications_returnsNotificationsInDescendingTimeOrder() = runTest (timeout = 120.seconds) {
